...
export function rn_footer2(option){
    let setting = {
        titleAlign : 'center',
        footerColor : '#7EE9D1',
        textColor : '#fff',
    ...
    return (
        <View style={[footerStyles.footer, setting.footerAdd]}>

            <TouchableOpacity style={[footerStyles.footerItem,]} onPress={setting.func}>
                <Text style={[footerStyles.footerTextAlign,footerStyles.footerTextColor,footerStyles.footerTextSize]}>Change Screen</Text>
            </TouchableOpacity>
