...
import Fingerprint from './FingerSrc/Application.container';

class FingerSample extends Component {
    render() {
        return (
...
export default connect(mapStateToProps, mapDispatchToProps)(FingerSample)
